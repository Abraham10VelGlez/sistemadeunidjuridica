...
@endif
       ...
       @if(isset($oficce)) 
       {!! Form::open(array('url' => '/ingresadatoseditadosper', 'method' => 'post', 'files' => true)) !!} 
       ...
       <div class="row">
                ...
                <div class="col-md-12 center-block">                                     
                  ...
                  <div class="col-md-3">
                  <input class="form-control" type="text" id="numerales" name="numerales"   >
                  </div>                                     
                  </div>
                  </div>
